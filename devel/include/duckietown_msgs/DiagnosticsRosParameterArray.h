...
struct DiagnosticsRosParameterArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::duckietown_msgs::NodeParameter_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::duckietown_msgs::NodeParameter_<ContainerAllocator> >::other >  _params_type;
  _params_type params;
