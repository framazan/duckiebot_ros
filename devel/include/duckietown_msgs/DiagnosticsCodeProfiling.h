...
struct DiagnosticsCodeProfiling_
{
  ...
  _node_type node;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _block_type;
  _block_type block;
...
struct Printer< ::duckietown_msgs::DiagnosticsCodeProfiling_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::duckietown_msgs::DiagnosticsCodeProfiling_<ContainerAllocator>& v)
  {
    ...
    s << indent << "block: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.block);
    s << indent << "frequency: ";
