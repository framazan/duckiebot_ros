...
struct NodeGetParamsListResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::duckietown_msgs::NodeParameter_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::duckietown_msgs::NodeParameter_<ContainerAllocator> >::other >  _parameters_type;
